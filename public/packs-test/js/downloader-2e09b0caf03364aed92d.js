...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function edit_text() {
    ...
    if (is_editable == 'true') document.getElementById('edit_txt_btn').innerHTML = 'Save Changes';else document.getElementById('edit_txt_btn').innerHTML = 'Edit Text';
    var spans = document.getElementById('transcription_text').getElementsByTagName('span');
...
/******/ });
//# sourceMappingURL=downloader-2e09b0caf03364aed92d.js.map