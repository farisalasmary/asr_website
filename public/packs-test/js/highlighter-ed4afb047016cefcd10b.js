  ...
  function highlight_word() {
    ...
    for (i = 0; i < segments_starts.length; i++) {
      if (segments_starts[i] <= currentTime && segments_ends[i] >= currentTime) {
        if (is_editable == 'false') document.getElementById('word_' + i).setAttribute("style", "background-color:gray; color:black");
      } else {
...
/******/ });
//# sourceMappingURL=highlighter-ed4afb047016cefcd10b.js.map