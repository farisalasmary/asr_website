...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function download_srt() {
    ...
    for (i = 0, l = spans.length; i < l; i += num_words_per_sentence) {
      words = '';
      word = (spans[i].textContent || spans[i].innerText) + ' ';
      if (i != 0) start_time = format_time(segments_starts[i] + 1);else start_time = format_time(segments_starts[i]);
      end_time = start_time;
...
/******/ });
//# sourceMappingURL=downloader-833a01f72828a42d0b75.js.map