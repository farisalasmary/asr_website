...
document.addEventListener('DOMContentLoaded', function () {
  ...
  audio_controller.ontimeupdate = function () {
    highlight_word();
  ...
  function highlight_word() {
    ...
    for (i = 0; i < segments_starts.length; i++) {
      if (segments_starts[i] <= currentTime && segments_ends[i] >= currentTime) {
        document.getElementById('word_' + i).setAttribute("style", "background-color:green; color:white");
      } else {
  ...
  for (var i = 0; i < words.length; i++) {
    document.getElementById("word_" + i).addEventListener("click", download_txt);
  }
});
...
/******/ });
//# sourceMappingURL=highlighter-33abf59a36d97d4d6763.js.map