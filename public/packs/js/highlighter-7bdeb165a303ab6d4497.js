  ...
  function highlight_word() {
    ...
    for (i = 0; i < segments_starts.length; i++) {
      if (segments_starts[i] <= currentTime && segments_ends[i] >= currentTime) {
        if (is_editable == 'false') document.getElementById('word_' + i).setAttribute("style", "background-color:#FFFF00; color:black");
      } else {
...
/******/ });
//# sourceMappingURL=highlighter-7bdeb165a303ab6d4497.js.map