...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function edit_text() {
    ...
    //        for(var i = 0; i < spans.length; i++){
    //            console.log(spans[i].getAttribute("contenteditable")); 
    //            spans[i].setAttribute("contenteditable", is_editable); 
    //        }
    console.log('before is_editable: ' + is_editable);
    is_editable = is_editable == 'true' ? 'false' : 'true';
    console.log('after is_editable: ' + is_editable);
  }
...
/******/ });
//# sourceMappingURL=downloader-3120a010e38638fcc66d.js.map